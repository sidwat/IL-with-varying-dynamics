...
python3 train_driving.py --env ContinuousFastRandom-v0 --num-epochs 3000 --demo_file_list demos/driving-fast.pkl demos/driving-slow.pkl demos/driving-fast-suboptimal.pkl --log-interval 10  --result_file results/driving_results/fast_slow_fast-feas_conf.pkl --snapshot_file snapshot/driving_snapshot/fast_slow_fast-feas_conf.tar --percent_list 0.3 0.60 0.1 --feasibility --optimality --delta-s 0.01  --sigma 150. --test_episodes 1 --test_seed 1001

python3 train_driving.py --env ContinuousFastRandom-v0 --num-epochs 3000 --demo_file_list /home/smart/PPO-PyTorch/new_data/ContinuousFastRandom-v0/combined_list_fast_optimal.pkl /home/smart/PPO-PyTorch/new_data/ContinuousSlowRandom-v0/combined_list_slow_optimal.pkl /home/smart/PPO-PyTorch/new_data/ContinuousFastRandom-v0/combined_list_fast_suboptimal.pkl  --log-interval 10 --test_episodes 100 --result_file results/driving_results/fast_slow_fast-feas_conf.pkl --snapshot_file snapshot/driving_snapshot/fast_slow_fast-feas_conf.tar --percent_list 0.3 0.60 0.1 --feasibility --optimality  --sigm
a 150.